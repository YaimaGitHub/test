...
const translations = {
  es: {
    ...
    'discount': 'Descuento:',
    'subtotal': 'Subtotal:',
    'proceed.to.pay': 'Proceder al Pago por WhatsApp',
    
    // WhatsApp Checkout
    'whatsapp.checkout': 'Pago por WhatsApp',
    'service.type': 'Tipo de Servicio',
    'home.delivery': 'Entrega a domicilio',
    'pickup.store': 'Pedido para recoger en el local',
    'whatsapp.number': 'Tu número de WhatsApp',
    'select.country': 'Seleccionar país',
    'who.picks.up': '¿Quién recoge el pedido?',
    'name': 'Nombre',
    'phone': 'Teléfono',
    'any.clarification': '¿Quieres aclararnos algo?',
    'delivery.location': '¿Dónde entregamos su pedido?',
    ...
    // Best Sellers / Market Info
    'market.info': 'Información del Mercado Cubano',
  ...
  en: {
    ...
    'discount': 'Discount:',
    'subtotal': 'Subtotal:',
    'proceed.to.pay': 'Proceed to WhatsApp Payment',
    
    // WhatsApp Checkout
    'whatsapp.checkout': 'WhatsApp Payment',
    'service.type': 'Service Type',
    'home.delivery': 'Home delivery',
    'pickup.store': 'Store pickup',
    'whatsapp.number': 'Your WhatsApp number',
    'select.country': 'Select country',
    'who.picks.up': 'Who picks up the order?',
    'name': 'Name',
    'phone': 'Phone',
    'any.clarification': 'Any clarification?',
    'delivery.location': 'Where do we deliver your order?',
    ...
    // Best Sellers / Market Info
    'market.info': 'Cuban Market Information',
